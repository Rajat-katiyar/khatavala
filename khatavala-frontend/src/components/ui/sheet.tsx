...
/**
 * shadcn/ui Sheet — a side panel built on Radix Dialog.
 *
 * Unlike `modal.tsx`, which is hand-rolled on purpose, this one takes the Radix
 * dependency: the customer drawer holds a long scrolling form, and focus
 * trapping, scroll locking and correct aria wiring for that are exactly the
 * things a hand-rolled panel gets subtly wrong.
 */
...
const SheetHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn('flex flex-col space-y-1.5 border-b px-6 py-4 text-left', className)}
    {...props}
  />
);
